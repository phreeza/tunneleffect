...
\author{Thomas McColgan and Miguel Garc\'ia Echevarr\'ia\\
	\small{\textit{Laboratorio de Bajas Temperaturas, Dpto. de Física de la Materia Condensada}} \\
...
%-----------------------------------------------------------------
\section*{Summary}
This method has arised very suitable to prove the general validity of the BCS theory, even to stand out the small discrepancies with the real density of states. Numerical computation with Levenberg-Marquard method is not adequate because BCS theory is not totally compatible with experimental data, and probably  it would not be much more adequate other routine. It results incredibly accurate fitting the data ``by hand''.
