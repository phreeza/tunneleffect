...
\caption{\small Experimental data and BCS theoretical prediction for Conductance at $1.45 K$. The discrepancy in I-V curve in fig. \ref{iv-7-exp_theo} has its corresponding here. 
\label{gv_theo_exp_7}}
\end{figure}
