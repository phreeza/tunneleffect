...
do n=1,size(v)
   ...
   didparam(n,1) =  - (int(n) -  qromo(integrand,ia,ib,midpnt,v(n),temp,epsilon+hEpsilon))/hEpsilon
   ...
   didparam(n,2) = - (int(n) -  qromo(integrand,ia,ib,midpnt,v(n),temp+hTemp,epsilon))/hTemp 
